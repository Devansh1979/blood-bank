...
<?php
 ...
 $sqlchk="SELECT * FROM patient_registration where Login_Id='".$varlogin."'";
    ...
    if($rowcount==1)
    {
       ...
       $sql="UPDATE patient_registration set Password='".$varpass1."' 
  WHERE login_id='".$varlogin."'";
       ...
       //echo"1 record added";
          ...
          {
              $msg1= " Hello <b style='color:red; '> $varlogin </b>,<br/><br/> Welcome to Life Care Blood Bank ,<br/><br/> <b>Your login ID is :</b><b style='color:red;'> $varlogin </b> ,<br/><br/><b> Your login Password is :<b style='color:red; '>  $varpass1 </b>,<br/><br/> ";
                 email_send($varlogin," Your Password for Life Care Blood Bank Login", $msg1);
                  echo "<script> 
   ...
   {
 echo "<script> alert('Kindly Enter Registered Email Id  !!!'); </script>";
 }
        ...
        <div class="container" data-scrollax-parent="true">
          <div class="row slider-text align-items-end">
            <div class="col-md-7 col-sm-12 ftco-animate mb-5">
              <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="index.php">Home</a></span> <span>Forgot Password</span></p>
              <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Forgot Password</h1>
            </div>
          </div>
        </div>
      </div>
